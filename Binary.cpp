...
main()
{
    ...
    cout << "Time for n = "<<na<<" in ns: " << (stop_a1-start_a1)/double(CLOCKS_PER_SEC)*1000000000<< endl;
    cout << "Time for n = "<<nb<<" in ns: " << (stop_b1-start_b1)/double(CLOCKS_PER_SEC)*1000000000<< endl;
    cout << "Time for n = "<<nc<<" in ns: " << (stop_c1-start_c1)/double(CLOCKS_PER_SEC)*1000000000<< endl;
    cout << "Time for n = "<<nd<<" in ns: " << (stop_d1-start_d1)/double(CLOCKS_PER_SEC)*1000000000<< endl;
